...
type Props = {
  onSubmit: (receiverEncryptionKeyHex: string, amount: string) => void
}

type TransferBottomSheetRef = {
  openWithPrefill: (receiverAddress: string, amount: string) => void
  present: () => void
  dismiss: () => void
}
...
export const useTransferBottomSheet = () => {
  ...
  const openWithPrefill = (receiverEncryptionKeyHex: string, amount: string) => {
  ...
  ({ onSubmit }, ref) => {
    ...
    const submit = useCallback(
      () =>
        handleSubmit(formData => {
          ...
          try {
            console.log('here')
            onSubmit(formData.receiverEncryptionKey, formData.amount)
          } catch (error) {
    ...
    useImperativeHandle(
      ...
      () => ({
        ...
        openWithPrefill: (receiverEncryptionKeyHex: string, amount: string) => {
